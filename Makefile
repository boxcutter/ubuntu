...
VMWARE_TEMPLATE_FILENAMES = $(filter-out ubuntu1510-i386.json ubuntu1510.json ubuntu1504-desktop.json,$(TEMPLATE_FILENAMES))
...
VIRTUALBOX_TEMPLATE_FILENAMES = $(filter-out ubuntu1510-i386.json ubuntu1510.json ubuntu1504-desktop.json,$(TEMPLATE_FILENAMES))
...
PARALLELS_TEMPLATE_FILENAMES = $(filter-out ubuntu1510-i386.json ubuntu1510.json ubuntu1504-desktop.json,$(TEMPLATE_FILENAMES))
